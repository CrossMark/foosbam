...
class Result(db.Model):
    ...
    checked_at: so.Mapped[datetime] = so.mapped_column(sa.DateTime(timezone=True), server_default=sa.func.now())
    checked_by: so.Mapped[int] = so.mapped_column(sa.ForeignKey(User.id))
